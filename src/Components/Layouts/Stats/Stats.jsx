...
const Stats = () => {
  return (
    <div className=" py-14">
      <div className="max-w-screen-xl mx-auto border border-cyan-600 border-opacity-40 p-10 rounded-lg overflow-hidden relative">
        ...
        <div className=" flex justify-between items-center flex-wrap gap-10 md:gap-0 ">
          ...
          <div className="border h-24 border-cyan-600 border-opacity-40"></div>
          ...
          <div className="border h-24 hidden md:flex border-cyan-600 border-opacity-40"></div>
